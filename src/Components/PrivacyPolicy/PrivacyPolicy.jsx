  ...
  return (
    <div className="bg-white py-12 px-6 md:px-16 lg:px-24">
      <div className="max-w-5xl mx-auto">
        ...
        <h3 className="text-2xl font-semibold text-indigo-700 mt-6 mb-2 text-center">Information We Collect</h3>
        <p className="text-gray-700 text-lg mb-4">
        ...
        <h3 className="text-2xl font-semibold text-indigo-700 mt-6 mb-2 text-center">How We Use Your Information</h3>
        <ul className="list-disc list-inside text-gray-700 text-lg mb-4">
        ...
        <h3 className="text-2xl font-semibold text-indigo-700 mt-6 mb-2 text-center"> Data Security</h3>
        <p className="text-gray-700 text-lg mb-4">
        ...
        <h3 className="text-2xl font-semibold text-indigo-700 mt-6 mb-2 text-center">Third-Party Services</h3>
        <p className="text-gray-700 text-lg mb-4">
        ...
        <h3 className="text-2xl font-semibold text-indigo-700 mt-6 mb-2 text-center">Your Rights</h3>
        <p className="text-gray-700 text-lg mb-4">
        ...
        <h3 className="text-2xl font-semibold text-indigo-700 mt-6 mb-2 text-center">Changes to This Policy</h3>
        <p className="text-gray-700 text-lg mb-4">
