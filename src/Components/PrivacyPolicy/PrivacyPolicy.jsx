  ...
  return (
    <div className="bg-white py-12 px-6 md:px-16 lg:px-24">
      <div className="max-w-5xl mx-auto">
        <h2 className="text-4xl font-bold text-indigo-800 mb-6 text-center">Privacy Policy</h2>
        ...
        <h3 className="text-2xl font-semibold text-indigo-700 mt-6 mb-2 text-center">1. Information We Collect</h3>
        <p className="text-gray-700 text-lg mb-4">
        ...
        <h3 className="text-2xl font-semibold text-indigo-700 mt-6 mb-2 text-center">2. How We Use Your Information</h3>
        <ul className="list-disc list-inside text-gray-700 text-lg mb-4">
        ...
        <h3 className="text-2xl font-semibold text-indigo-700 mt-6 mb-2 text-center">3. Data Security</h3>
        <p className="text-gray-700 text-lg mb-4">
        ...
        <h3 className="text-2xl font-semibold text-indigo-700 mt-6 mb-2 text-center">4. Third-Party Services</h3>
        <p className="text-gray-700 text-lg mb-4">
        ...
        <h3 className="text-2xl font-semibold text-indigo-700 mt-6 mb-2 text-center">5. Your Rights</h3>
        <p className="text-gray-700 text-lg mb-4">
        ...
        <h3 className="text-2xl font-semibold text-indigo-700 mt-6 mb-2 text-center">6. Changes to This Policy</h3>
        <p className="text-gray-700 text-lg mb-4">
