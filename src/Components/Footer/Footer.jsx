...
const Footer = () => {
  return (
    ...
    color: 'white',
      ...
      <nav>
        <div className="grid grid-flow-col gap-4">
          <a href="https://x.com/" target="_blank" rel="noopener noreferrer">
              ...
              height="24"
              viewBox="0 0 24 24"
              className="fill-current hover:text-blue-200 text-white">
              <path
      ...
      <aside>
        <p className='!text-white'>Copyright © {new Date().getFullYear()} - All right reserved by SECJAF - Language Learning Platform</p>
      </aside>
    </footer>
  );
};
